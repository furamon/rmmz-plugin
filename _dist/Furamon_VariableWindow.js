...
(() => {
    ...
    class Window_TemporaryText extends Window_Base {
        ...
        _fullWidth; // 画面幅フラグ
        _textAlign; // 文字揃え
        constructor(rect, text, duration, fontSize, position, fullWidth, textAlign) {
            super(rect);
            this._text = text;
    ...
    // --- プラグインコマンドの登録 ---
    PluginManager.registerCommand(pluginName, "showTextTemporarily", function (args) {
