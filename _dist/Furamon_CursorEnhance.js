...
(function () {
    ...
    Window_Selectable.prototype.update = function (...args) {
        _Window_Selectable_update.apply(this, args);
        try {
    ...
    Window_Selectable.prototype.createCursorEnhanceSprite = function () {
        createCursorEnhanceSprite(this);
    };
})();
