...
(function () {
    ...
    // Tauriの初期化を待つPromise
    const tauriReady = new Promise((resolve) => {
    ...
    async function setupTauriAndTouchEvents() {
        try {
            ...
            if (platform === 'android' || platform === 'ios') {
                console.log('Mobile device detected. Preventing default touch behavior.');
            ...
            console.error('Error during Tauri setup or touch event prevention:', error);
        }
    }
    // 起動時
    ...
    ConfigManager.applyData = function (config) {
        ...
        this.tauriWindowSize = this.readTauriWindowSize(config);
    };
    ...
    // 表示名
    function currentWindowSizeText(value) {
        // ハードコーディングでゴリ押す。
