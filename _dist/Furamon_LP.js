...
(function () {
    ...
    Game_Actor.prototype.refresh = function () {
        _Game_Actor_refresh.apply(this, []);
        this.maxLPSet();
        if (this.lp == null) {
            this.recoverLP();
        }
    ...
    Game_Action.prototype.makeTargets = function () {
        let targets = _Game_Action_makeTargets.apply(this, []);
        ...
        if (this.subject().isEnemy() && item?.scope === 2) {
    ...
    Game_Action.prototype.apply = function (target) {
        ...
        if (lpRecover) {
            const recoverValue = Math.floor(eval(String(lpRecover)));
            // 対象が敵なら即死させる
            if (target.isEnemy()) {
    ...
    Game_Actor.prototype.addNewState = function (stateId) {
        _Game_Actor_addNewState.apply(this, [stateId]);
    ...
    Game_Actor.prototype.regenerateHp = function () {
        _Game_Actor_regenerateHp.apply(this, []);
        if (this.hp === 0) {
            gainLP(this, -1);
    ...
    Game_Actor.prototype.canPaySkillCost = function (skill) {
        ...
        if (this.isActor()) {
            ...
            if (LPCost) {
                return (_Game_Actor_canPaySkillCost.apply(this, [skill]) && this._lp > LPCost);
            }
        }
        return _Game_Actor_canPaySkillCost.apply(this, [skill]);
    };
    // LP消費
    const _Game_Actor_paySkillCost = Game_Actor.prototype.paySkillCost;
    Game_Actor.prototype.paySkillCost = function (skill) {
        _Game_Actor_paySkillCost.apply(this, [skill]);
        // アクターのみ対象
        if (this.isActor()) {
            const LPCost = skill.meta["LP_Cost"];
            if (LPCost) {
    ...
    Window_BattleLog.prototype.displayDamage = function (target) {
        _Window_BattleLog_displayDamage.apply(this, target);
        if (target.result().lpDamage > 0 && target.isActor()) {
            this.push("addText", LPBreakMessage(target.name(), target.result().lpDamage));
        }
        else if (target.result().lpDamage < 0 && target.isActor()) {
            this.push("addText", LPGainMessage(target.name(), target.result().lpDamage));
        }
    };
    // LPをウィンドウに描画
    // LPゲージタイプの定義
    ...
    Sprite_Gauge.prototype.initMembers = function () {
        _Sprite_Gauge_initMembers.apply(this, []);
    ...
    Sprite_Gauge.prototype.setup = function (battler, statusType) {
        _Sprite_Gauge_setup.apply(battler, statusType);
    ...
    Sprite_Gauge.prototype.currentValue = function () {
        if (this._statusType === GAUGE_TYPE_LP) {
            return this._battler?._lp ?? 0;
        }
        return _Sprite_Gauge_currentValue.apply(this, []);
    };
    const _Sprite_Gauge_currentMaxValue = Sprite_Gauge.prototype.currentMaxValue;
    Sprite_Gauge.prototype.currentMaxValue = function () {
        if (this._statusType === GAUGE_TYPE_LP) {
            return this._battler?.mlp ?? 0;
        }
        return _Sprite_Gauge_currentMaxValue.apply(this, []);
    };
    ...
    Sprite_Gauge.prototype.gaugeColor1 = function () {
        ...
        return _Sprite_Gauge_gaugeColor1.apply(this, []);
    };
    ...
    Sprite_Gauge.prototype.gaugeColor2 = function () {
        ...
        return _Sprite_Gauge_gaugeColor2.apply(this, []);
    };
    ...
    Sprite_Gauge.prototype.label = function () {
        ...
        return _Sprite_Gauge_label.apply(this, []);
    };
    ...
    Window_Status.prototype.drawBlock2 = function (y) {
        ...
        _Window_Status_drawBlock2.apply(this, [y + lineHeight]); // 他のゲージの位置を下にずらす
    };
    const _Window_StatusBase_placeBasicGauges = Window_StatusBase.prototype.placeBasicGauges;
    Window_StatusBase.prototype.placeBasicGauges = function (actor, x, y) {
        _Window_StatusBase_placeBasicGauges.apply(this, actor);
        // LP描画を追加
    ...
    Game_Action.prototype.testApply = function (target) {
        const item = this.item();
        if ((item &&
            Number(item.meta["LP_Recover"]) > 0 &&
            target._lp < target.mlp) ||
            (item && Number(item.meta["LP_Recover"]) < 0)) {
            return true;
        }
        return Game_Action_testApply.apply(this, target);
    };
    // 戦闘ステータスの座標上げ
    ...
    Window_BattleStatus.prototype.basicGaugesY = function (rect) {
        return (_Window_BattleStatus_basicGaugesY.apply(this, [rect]) -
